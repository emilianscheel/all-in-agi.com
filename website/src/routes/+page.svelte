...
<section id="preis" class="pricing">
	<div class="section-wrap">
		...
		<div class="pricing-grid" use:reveal={{ group: true }}>
			<article class="price-card"><h3>Bis 15 Personen</h3><strong>3.000 €</strong><span>netto</span><ul><li><Users size={17} />1 Facilitator</li><li><Lightbulb size={17} />Challenge Design</li><li><Presentation size={17} />Demo Day & Follow-up</li><li><Pizza size={17} />Pizza Lunch inklusive</li><li><CircleMinus size={17} />Ohne Lunch −500 €</li><li><Utensils size={17} />Custom Catering +500 €</li></ul></article>
			<article class="price-card featured"><span class="tag">Most popular</span><h3>Bis 30 Personen</h3><strong>4.500 €</strong><span>netto</span><ul><li><Users size={17} />2 Facilitators</li><li><Lightbulb size={17} />Challenge Design</li><li><Presentation size={17} />Demo Day & Follow-up</li><li><Pizza size={17} />Pizza Lunch inklusive</li><li><CircleMinus size={17} />Ohne Lunch −500 €</li><li><Utensils size={17} />Custom Catering +500 €</li></ul></article>
			<article class="price-card"><h3>Bis 50 Personen</h3><strong>6.500 €</strong><span>netto</span><ul><li><Users size={17} />3 Facilitators</li><li><Lightbulb size={17} />Challenge Design</li><li><Presentation size={17} />Demo Day & Follow-up</li><li><Pizza size={17} />Pizza Lunch inklusive</li><li><CircleMinus size={17} />Ohne Lunch −500 €</li><li><Utensils size={17} />Custom Catering +500 €</li></ul></article>
		</div>
